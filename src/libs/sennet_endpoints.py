...
sennet_blueprint = Blueprint('sennet_blueprint', __name__)


@sennet_blueprint.route('/assaytype', methods=['GET'])
def __assaytypes():
    return assaytypes()

@sennet_blueprint.route('/assaytype/<name>', methods=['GET'])
@sennet_blueprint.route('/assayname', methods=['POST'])
def __assayname(name=None):
    return assayname(name)


# @sennet_blueprint.route('/testmethod', methods=['GET'])
# def testmethod():
